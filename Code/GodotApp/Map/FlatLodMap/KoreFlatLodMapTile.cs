...
public partial class KoreFlatLodMapTile : Node3D
{
    // Basic tile info
    public KoreMapTileCode TileCode;
    public KoreFlatLodMapTile? ParentTile = null;

    // Derived TileCode properties (for convenience)
    KoreLLAPoint  CenterLLA = new KoreLLAPoint();
    KoreXYZVector CenterXYZ = new KoreXYZVector();

    // Mesh and material
    public KoreMeshData? TileMesh = null;
    public KoreMeshMaterial? TileMaterial = null;
    public KoreUVBox? UVBox = null;
    ...
    public KoreFlatLodMapTile(KoreMapTileCode tileCode, KoreMeshMaterial? globalTileMaterial)
    {
        TileCode = tileCode;
    ...
    public override void _Ready()
    {
        ...
        KoreLLAPoint[,] tps = TilePoints(20, boundsbox);

        // Get the uvBox for the tile and create the tile mesh
        UVBox = KoreMapTileCodeOps.TileGlobalUVBox(TileCode);
        TileMesh = TileFromPoints(tps, UVBox.Value);
    ...
    public void RefineParentTileUVBox()
    {
    ...
    public KoreLLAPoint[,] TilePoints(int pointsPerSide, KoreLLBox boundsbox)
    {
    ...
    public KoreMeshData TileFromPoints(KoreLLAPoint[,] points, KoreUVBox uvBox)
    {

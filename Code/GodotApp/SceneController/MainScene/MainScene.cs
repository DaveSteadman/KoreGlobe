...
public partial class MainScene : Node3D
{
    ...
    public void AddTestMeshData_MapManager()
    {
        ...
        // AddChild(MapManagerNode);
        // MapManagerNode.Position = new Vector3(0, -1.0f, -2.5f);

        // // Test MapManager Mesh
        // {
        //     KoreMapManager mapManager = new KoreMapManager();
        //     mapManager.AddTestData();

        //     KoreGodotLineMesh childMeshNode1 = new KoreGodotLineMesh();
        //     childMeshNode1.UpdateMesh(mapManager.MeshData);

        //     KoreGodotSurfaceMesh childSurfaceMeshNode1 = new KoreGodotSurfaceMesh();
        //     childSurfaceMeshNode1.UpdateMesh(mapManager.MeshData);

        //     MapManagerNode.AddChild(childMeshNode1);
        //     MapManagerNode.AddChild(childSurfaceMeshNode1);
        // }
    }

...
public static class KorePositionLibrary
{
    public static readonly Dictionary<string, KoreLLPoint> Positions = new Dictionary<string, KoreLLPoint>
    {
        ...
        { "Colombo",       new KoreLLPoint() {LatDegs = 6.9271, LonDegs = 79.8612} },
        { "Kathmandu",     new KoreLLPoint() {LatDegs = 27.7172, LonDegs = 85.3240} },
        { "Thimphu",       new KoreLLPoint() {LatDegs = 27.4728, LonDegs = 89.6390} },
        ...
        { "Doha",          new KoreLLPoint() {LatDegs = 25.2854, LonDegs = 51.5310} },
